        ...
        <div className="space-y-6 py-2">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-popover p-4 rounded-xl border border-border/20 transition-all duration-300">
                ...
                <div className="flex-1 min-w-0">
                    <h2 className="text-xl font-bold text-foreground truncate">{fornecedor.nome}</h2>
                    <div className="flex items-center gap-2 mt-1">
                        <Badge variant={fornecedor.active ? "success" : "destructive"} className="text-[10px] uppercase">
                            {fornecedor.active ? "Ativo" : "Arquivado"}
                        </Badge>
                        <span className="text-xs text-muted-foreground flex items-center gap-1">
                            <Calendar className="h-3 w-3" />
                            Desde {fornecedor.created_at ? new Date(fornecedor.created_at).toLocaleDateString() : "-"}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4 flex flex-col h-full">
                    ...
                    <div className="p-4 space-y-4 border border-border/20 bg-popover shadow-sm rounded-xl flex-1">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-foreground break-all">{fornecedor.email || "Não informado"}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-foreground">{fornecedor.telefone || "Não informado"}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-foreground">{fornecedor.contato || "Não informado"}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-foreground leading-relaxed">{fornecedor.endereco || "Não informado"}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4 flex flex-col h-full">
                    ...
                    <div className="mt-4 p-4 rounded-xl bg-accent border border-border/20 flex-1">
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed min-h-[60px]">
                            {fornecedor.observacoes || "Nenhuma observação interna registrada para este fornecedor até o momento."}
                        </p>
                    </div>
                </div>
            </div>
