  ...
  const t = (k: string) => {
    const d: Record<string, { pt: string; fr: string }> = {
      ...
      "Notificações bloqueadas pelo navegador": {
        pt: "Notificações bloqueadas pelo navegador",
        fr: "Notifications bloquées par le navigateur",
      },
      ...
      "Enviando notificação de teste...": {
        pt: "Enviando notificação de teste...",
        fr: "Envoi d'une notification de test...",
      },
