    ...
    return (
        ...
        >
            ...
            <div className="relative flex w-full items-center justify-between">
                ...
                >
                    <SunIcon className={cn(sizes.icon, "transition-transform duration-300", !isDark && "scale-110")} />
                </div>
                ...
                >
                    <MoonIcon className={cn(sizes.icon, "transition-transform duration-300", isDark && "scale-110")} />
                </div>
            </div>
            ...
            <span
                className={cn(
                    ...
                    sizes.indicator,
                    isDark
                        ? "right-0.5 left-auto bg-background border border-border shadow-lg"
                        : "left-0.5 right-auto bg-background border border-border shadow-md",
                )}
            />
        </button>
    );
