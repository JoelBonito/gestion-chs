          ...
          if (encomenda) {
            ...
            if (userEmail === "msilva.lipe@gmail.com") {
              ...
              await sendEmail(
                ...
                emailTemplates.observacaoJoel(
                  encomenda.numero_encomenda,
                  encomenda.etiqueta || "N/A",
                  editValue
                )
              );
            } else if (
              userEmail === "jbento1@gmail.com" ||
              userEmail === "felipe@colaborador.com"
            ) {
              // Observação do Felipe - enviar para Lipe
              await sendEmail(
                emailRecipients.lipe,
                `📝 Observação Felipe — ${encomenda.numero_encomenda}`,
                emailTemplates.observacaoFelipe(
                  encomenda.numero_encomenda,
                  encomenda.etiqueta || "N/A",
                  editValue
                )
    ...
    <Card className="w-full">
      ...
      <CardContent className="pt-0">
        {isEditing ? (
          ...
          <div className="text-muted-foreground min-h-[60px] text-sm">
