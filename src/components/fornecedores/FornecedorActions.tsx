  ...
  return (
    <div className="border-border/30 flex items-center gap-2 border-t pt-2">
      ...
      <button
        ...
        aria-label={fornecedor.active ? "Arquivar fornecedor" : "Reativar fornecedor"}
        disabled={isLoading}
      >
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="bg-card border-none shadow-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir permanentemente o fornecedor "{fornecedor.nome}"? Esta
              ação não pode ser desfeita e removerá todos os dados arquivados.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
