...
export function HorizontalNav() {
  ...
  return (
    <nav className="bg-background/95 supports-[backdrop-filter]:bg-background/60 border-border/50 sticky top-0 z-50 border-b backdrop-blur">
        ...
        <div className="flex h-16 items-center justify-between px-4 sm:px-6">
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              />
              <span className="from-primary to-primary-glow hidden bg-gradient-to-r bg-clip-text text-xl font-bold text-transparent sm:inline-block">
                Gestion CHS
              </span>
            </Link>
          </div>
              ...
              {filteredNavigation.map((item) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={cn(
                        "flex shrink-0 items-center justify-center rounded-full p-2 transition-all duration-500",
                        (item as any).bg,
                        (item as any).color,
