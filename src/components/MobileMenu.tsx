      ...
      <SheetContent side="left" className="w-[300px] sm:w-[350px]">
        <SheetHeader className="space-y-3">
          <div className="flex items-center space-x-3">
            <img src="/logo-inove.jpg" alt="Gestion CHS Logo" className="h-8 w-auto" />
            <SheetTitle className="from-primary to-primary-glow bg-gradient-to-r bg-clip-text text-lg font-bold text-transparent">
              Gestion CHS
            </SheetTitle>
          </div>
          ...
          {filteredNavigation.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "flex shrink-0 items-center justify-center rounded-full p-2.5 transition-all duration-500",
                    (item as any).bg,
                    (item as any).color,
