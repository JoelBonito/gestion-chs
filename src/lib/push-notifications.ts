...
export const PushNotifications = {
  ...
  statusAlterado: (numero: string, novoStatus: string) =>
    sendPushNotification({
  ...
  pagamentoRecebido: (valor: number, cliente?: string) =>
    sendPushNotification({
  ...
  pagamentoEfetuado: (valor: number, fornecedor?: string) =>
    sendPushNotification({
