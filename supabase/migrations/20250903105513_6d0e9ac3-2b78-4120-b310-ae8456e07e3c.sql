-- Create RPC function for saving order edits
...
declare
  ...
  v_ids_enviados int;
begin
  -- 2.0 Segurança: só o dono pode editar
  ...
  select id, p_encomenda_id, produto_id, quantidade, preco_unitario
  from dados
